<template>
  <v-footer app height="40">
    <a href="https://github.com/Gonanf" class="d-inline-block mx-2 social-link" rel="noopener noreferrer"
      target="_blank" title="Github"> <v-icon icon="mdi-github" :size="16" /></a>
